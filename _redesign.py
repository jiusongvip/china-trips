...
print("Hero replaced:", old_hero not in c)
...
print("Stats replaced:", old_stats not in c)
...
c = c.replace(old_trust, new_trust)
print("Trust replaced:", old_trust not in c)

# Also fix any remaining literal \u2014
c = c.replace(chr(92)+'u2014', chr(0x2014))
